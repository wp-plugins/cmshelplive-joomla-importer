...
<div class="alert-success" style=" text-align:center; padding:20px; margin-top:20px;"><?php echo $result;?></div>
<?php else:?>
...
<form method="post" action="admin.php?page=cmshelplivej2w_support">
  ...
  <input type="hidden" name="page" value="cmshelplivej2w_support" />
</form>
</div>
<?php endif; ?>
</div>
